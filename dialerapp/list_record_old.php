...
<div class="picker">
								<select id="disp" name="disp" class="selectpicker">
									...
									<option value="FA01 - Closed, Paid in Full">FA01 - Closed, 3rd Attempt Complete - VM/Email</option>
									<option value="FA02 - Closed, 3rd Attempt Complete - VM/Email">FA02 - Closed, Paid in Full</option>
									<option value="FA03 - Set Task, Partial Payment">FA03 - Do Not Call</option>
									<option value="FA04 - Set Task, Pay at a later date">FA04 - No Answer, Left VM/Sent Email</option>
									<option value="FA05 - No Answer, Left VM/Sent Email">FA05 - Set Task, Partial Payment</option>
									<option value="FA06 - Wrong Number, Sent Email/Updated Phone">FA06 - Set Task, Pay at a Later Date</option>
				...
				<form>
					...
					<div class="modal hide fade"  style="width: 700px; margin-left: -350px !important; " id="ipage" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						 ...
						 <div class="modal-body" style="max-height: 700px;">
						   ...
						   <iframe src="https://csgfast.com/oldcsgfast/ipages/ipage.php?un=<?php echo (preg_replace('~[\W_]~', '', $nice_recordfills)); ?>" width="650" frameborder='0' height="1000"></iframe>
						   </div>
						 </div>
