...
<!-- chart scripts -->
        <script src="https://csgfast.com/js/jquery.js"></script>
        <script src="https://csgfast.com/plugins/jqPlot/jquery.jqplot.min.js"></script>
        <script src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.cursor.min.js"></script>
        <script src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.highlighter.min.js"></script>
        <script src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.barRenderer.min.js"></script>
        <script src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.pointLabels.min.js"></script>
		
		<script type="text/javascript" src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.dateAxisRenderer.min.js"></script>
		<script type="text/javascript" src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.canvasTextRenderer.min.js"></script>
		<script type="text/javascript" src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.canvasAxisTickRenderer.min.js"></script>
		<script type="text/javascript" src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.categoryAxisRenderer.min.js"></script>
		<script type="text/javascript" src="https://csgfast.com/plugins/jqPlot/plugins/jqplot.barRenderer.min.js"></script>
<!-- /chart -->
		</head>
<div class="span12">
...
// add in fa12 to array -amber
			  ...
			  */
			  ...
			  // $bucketype = FFR | ALERT  $bucketid = link_record_id
