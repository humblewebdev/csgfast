...
"<table border='1'>
<tbody>
<tr><td><b>Level 3: LDAP User</b></td><td> This is a user who has signed in using their LDAP account. They will only be able to view
	the farmer's agent list. Additional privledges will depend on if their level is upgraded.
</td></tr>
<tr><td><b>Level 5: Admin</b></td><td> Admin are able to approve farmers agents and their products. They are able to send emails, and update
the corrisponding templates.</td></tr>
<tr><td><b>Level 7: Super Admin</b></td><td> Super admin are able to do all the functionality of LDAP and Admin, in addition to viewing this
	\"LDAP Users\" tab. They will be able to change the security level and remove other members from this list.</td></tr>
</tbody>
</table>";*/
															...
															<div class='modal-dialog'>
																<div class='modal-content'>
																	...
																	<div class='modal-footer' style='background-color: #E8E8E8;'>
																		<center>
																		<div class='form_row'>"; ?>
																			<!--<a href="#submissionmodal</?php echo $row['users_id']; ?>" data-toggle="modal" class="btn btn-primary green"> Yes</a>-->
...
//(<?php echo $row['users_id']; ?>,<?php echo $securityAction; ?>,<?php echo $securityForm; ?>)
