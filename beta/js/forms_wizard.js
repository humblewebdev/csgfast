    ...
    $('#rootwizard').bootstrapWizard({
        ...
        onNext: function(tab, navigation, index) {
            ...
            if (current >= total) {
                ...
                $('#rootwizard').find('.s-button').show();
            } else {
                $('#rootwizard').find('.next-button').show();
                $('#rootwizard').find('.s-button').hide();
            }
        },
    ...
    $('#rootwizard3').bootstrapWizard({
        ...
        onNext: function(tab, navigation, index) {
            ...
            if (current >= total) {
                ...
                $('#rootwizard3').find('.s-button').show();
            } else {
                $('#rootwizard3').find('.next-button').show();
                $('#rootwizard3').find('.s-button').hide();
            }
        },
        onPrevious: function (tab, navigation, index) {
    ...
    $('#rootwizard4').bootstrapWizard({
        ...
        onNext: function(tab, navigation, index) {
            ...
            if (current >= total) {
                ...
                $('#rootwizard4').find('.s-button').show();
            } else {
                $('#rootwizard4').find('.next-button').show();
                $('#rootwizard4').find('.s-button').hide();
            }
        },
        onPrevious: function (tab, navigation, index) {
