		...
		<div class="well <?php echo $info_ui_color; ?>">
			...
			<div class="well-content no-search">
				<table class="table_hours" border="0" width="100%" style="background-color:#FFF;  z-index: 100; font-size: 11px;" cellpadding="2" cellspacing="3">
					<tr><td><strong>AGENT CODE: </strong><?php Print "".$currentuser['agent_code']  . " ";   ?>
					</td></tr>
					<tr><td><strong>EMAIL: </strong><?php Print "".$currentuser['email']  . " ";   ?>
					</td></tr>
					<tr><td><strong>ADDRESS: </strong><?php Print "".$currentuser['address']  . ", " . $currentuser['city'] . ", " . $currentuser['state']. ", " . $currentuser['zipcode'];   ?>
					</td></tr>
					<tr><td><strong>FAX: </strong><?php Print "".formatPhone($currentuser['fax'])  . " ";   ?>
					</td></tr>
					<tr><td><strong>TIME ZONE: </strong><?php Print "".($currentuser['timezone'])  . " ";   ?>
					</td></tr>
				</table>
			</div>
		</div>
